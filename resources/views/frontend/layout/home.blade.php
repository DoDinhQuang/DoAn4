                ...
                <div class="col-sm-9">
                    <div class="beta-products-list">
                        ...
                        <div class="beta-products-details">
                            <p class="pull-left">Tìm thấy {{count($product_hot)}} sản phẩm</p>
                    ...
                    <div class="beta-products-list">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <div class="single-item">
                                    <div class="single-item-header">
                                        <a href="{{URL::to('home/type_details',$item->product_id)}}"><img src="{{asset('storage/app/upload/'.$item->product_img)}}" alt="" height="300px" width="250px"></a>
                                    </div>
                                    <div class="single-item-body">
                                        <p class="single-item-title">{{$item->product_name}}</p>
                                        <p class="single-item-price">
