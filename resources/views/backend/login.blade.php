...
<section style="height: 100vh;">
    ...
    <div class="baslik">
        <b style="font-size: 101px; text-align: center; margin-bottom: -21px; display: block;">LOGIN</b>
    ...
    <form method="post" action="">
        ...
        <div class="arkalogin">
            ...
            <input class="giris" type="text" name="email" placeholder="Tài khoản">
            <input class="giris" type="password" name="password" placeholder="Mật khẩu">
            <a href="#" target="blank"><input class="butonlogin" type="submit" name="" value="Đăng nhập"></a>
        </div>
    </form>
    </section><br>
